              ...
              <div className="relative max-w-5xl mx-auto px-6 py-20">
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-10">
                  ...
                  <div className="flex flex-col gap-4 lg:items-end shrink-0">
                    <a
                      href="#menu"
                      className="inline-flex items-center justify-center px-10 py-4 bg-primary text-background font-medium hover:bg-primary-hover transition-colors w-full lg:w-auto"
                    >
                      Order Now
                    </a>
                    <a
                      href={`tel:${phoneRaw}`}
                      className="inline-flex items-center justify-center gap-2 px-10 py-4 border border-accent text-foreground font-medium hover:bg-accent hover:text-background transition-colors w-full lg:w-auto"
                    >
